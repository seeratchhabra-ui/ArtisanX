...
class _AiProductUploadScreenState extends State<AiProductUploadScreen> {
  ...
  void _simulateMediaPick() async {
    ...
    setState(() {
      ...
      _previewImageUrl = 'https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=800&q=80';
    });

    // Auto-trigger AI scan on image upload
    _triggerVoiceInput();
  }
