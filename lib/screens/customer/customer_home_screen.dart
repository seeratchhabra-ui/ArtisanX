          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text(
                  'Open Artisan Workshop',
                ),
                subtitle: const Text(
                  'View the artisan dashboard',
                ),
                trailing: const Icon(
                  Icons.chevron_right,
                ),
                onTap: () {
                  ...
                  /*
                   * IMPORTANT:
                   * We do NOT call appState.setRole().
                   *
                   * This only navigates to the workshop UI.
                   * The authenticated backend role remains
                   * unchanged.
                   */
                  Navigator.of(context).push(
                    MaterialPageRoute(
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context)
                    ...
                    const SnackBar(
                      content: Text(
                        'Your orders are loaded from the backend.',
                      ),
                    ),
                  );
                },
                  ...
                  Row(
                    children: [
                      AccessibleSpeakerButton(
                        textToRead:
                            'नमस्ते! कलासेतु हस्तशिल्प बाज़ार में आपका स्वागत है। सीधे भारत के कारीगरों से हस्तनिर्मित उत्पाद खोजें।',
                        tooltip:
                            'Listen to marketplace overview via Bhashini',
                        size: 38,
                        glowColor:
                            AppTheme.terracotta,
                      ),
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ScaffoldMessenger.of(
                            ...
                            const SnackBar(
                              content: Text(
                                'Notifications loaded from the marketplace.',
                              ),
                            ),
                          );
                        },
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Namaste, ${appState.currentUser?.name ?? 'Customer'} 👋',
                      style: const TextStyle(
                        fontSize: 13,
                    ...
                    if (appState
                      ...
                      const Center(
                        child: Padding(
                          ...
                          child: Text(
                            'No craft products found in this category.',
                            style: TextStyle(
                              color:
                                  AppTheme.textMuted,
                              fontSize: 14,
